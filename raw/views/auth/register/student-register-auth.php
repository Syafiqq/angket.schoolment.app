...
<div class="register-box">
    ...
    <div class="register-box-body">
        <p class="register-box-msg">Silahkan Daftar untuk mengerjakan</p>
        ...
        <a href="<?php echo site_url('/auth/register?role=counselor') ?>">Saya adalah <b>Konselor</b>.</a><br>
        <a href="<?php echo site_url('/auth/login?role=student') ?>">Saya Sudah Punya Akun.</a>
