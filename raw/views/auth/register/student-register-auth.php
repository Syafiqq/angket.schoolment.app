...
<body>
<div class="container">
    <form class="well form-horizontal" id="register" action="<?php echo site_url('auth/do_register') ?>" method="post">
        <fieldset>
            <!-- Form Name -->
            ...
            <div class="form-group">
                <label class="col-md-4 control-label" for="coupon">Kode Registrasi</label>
                <div class="col-md-4 inputGroupContainer">
                    <div class="input-group">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                        <input id="coupon" placeholder="Kode Registrasi" name="coupon" type="text" class="form-control">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group" style="margin-top: 50px">
                ...
                <div class="col-md-4">
                    <b>Klik</b>
                    <a href="<?php echo site_url('/auth/register?role=counselor') ?>" type="submit" class="btn btn-warning">Konselor
                        <span class="glyphicon glyphicon-send"></span>
                    </a>
            ...
            <div class="form-group" style="margin-top: 20px">
                ...
                <div class="col-md-4">
                    <b>Klik</b>
                    <a href="<?php echo site_url('/auth/login?role=student') ?>" type="submit" class="btn btn-warning">Login
                        <span class="glyphicon glyphicon-send"></span>
                    </a>
                    <b>&nbsp;Apabila Sudah Punya Akun ?</b>
                </div>
            </div>
        </fieldset>
    </form>
...
<script type="text/javascript" src="<?php echo base_url('/assets/js/auth/register/student-register-auth.min.js') ?>"></script>
